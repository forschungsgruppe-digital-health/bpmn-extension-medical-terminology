...
| [`moddle-extension-review`](moddle-extension-review/SKILL.md) | changing a moddle type / property / namespace / prefix in `extension/src/moddle/medical-terminology.json` | `npm run check:conformance` |
